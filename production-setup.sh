...
HEALTH=$(curl -k -s -w "%{http_code}" -o /tmp/health.out https://lwxustotamin.online/api/health 2>/dev/null || echo "000")
...
echo "════════════════════════════════════════════════════════════════"
echo ""
echo "Next: To create admin user 'dr@lwxustotamin.online'"
