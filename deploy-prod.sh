...
# Example:
#   INS_SERVER_IP=69.57.161.222 INS_DOMAIN=tamminzonlinez.online INS_BRANCH=hardening/clean-rebuild bash deploy-prod.sh git@github.com:tegarahowner-ui/insurance2026.git
#
# Prerequisites:
...
INS_DOMAIN="${INS_DOMAIN:-tamminzonlinez.online}"
