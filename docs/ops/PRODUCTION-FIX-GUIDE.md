...
## 🔴 Current Issue: 500 Error on lexusforbon.com
...
# Check health
curl -k https://lexusforbon.com/api/health
...
- [ ] Website responds: `curl -k https://lexusforbon.com/api/health` returns `200`
- [ ] Admin users exist: Check database for `admin@lexusforbon.com` and `dr@lexusforbon.com`
...
5. **Verify certificates:**
   ...
   ```bash
   ls -la /etc/letsencrypt/live/lexusforbon.com/
   ```
...
```
URL: https://lexusforbon.com/login
Admin Email 1: admin@lexusforbon.com
Admin Email 2: dr@lexusforbon.com
