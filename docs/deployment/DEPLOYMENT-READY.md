...
bash deploy/legacy/deploy-prod.sh "git@github.com:YOUR_USERNAME/insurance2026.git"
```
...
4. **First Admin Login** — Username/email: `admin@tamnyfordr.online`, password from `.env.production` (ADMIN_PASSWORD)
...
Your app will be available at: `https://tamnyfordr.online`
