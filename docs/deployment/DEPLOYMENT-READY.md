...
4. **First Admin Login** — Username/email: `admin@lexusforbon.com`, password from `.env.production` (ADMIN_PASSWORD)
...
Your app will be available at: `https://lexusforbon.com`
