...
4. **First Admin Login** — Username/email: `admin@lwxustotamin.online`, password from `.env.production` (ADMIN_PASSWORD)
...
Your app will be available at: `https://lwxustotamin.online`
