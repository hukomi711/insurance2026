...
4. **First Admin Login** — Username/email: `admin@tamminzonlinez.online`, password from `.env.production` (ADMIN_PASSWORD)
...
Your app will be available at: `https://tamminzonlinez.online`
