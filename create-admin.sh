#!/bin/bash
# ════════════════════════════════════════════════════════════════
# Create Admin User: dr@tamminzonlinez.online
...
read -s -p "Enter password for dr@tamminzonlinez.online: " ADMIN_PASS
echo ""
...
User::query()
    ...
    ->whereIn("email", ["admin@tamminzonlinez.online", "dr@tamminzonlinez.online"])
    ->orderBy("id")
    ->get()
